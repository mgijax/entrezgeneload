...
isql -S${MGD_DBSERVER} -U${MGI_PUBLICUSER} -P${MGI_PUBPASSWORD} -w300 <<END >> ${REPORTFILE}
...
print ""
print "     New EntrezGene IDs added to MGI Rat symbol based on Symbol and Seq ID match"
print ""
