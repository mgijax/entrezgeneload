...
print ""
print "Bucket 7: MGD Rat Symbols with no LL ID, no RGD ID, no RatMap ID (the No-No-No set)"
print ""
print "     a.  Displays any matches between MGD and LL by LL Official or Interim Symbol"
print "     b.  Displays Mouse Symbol/Name if a Mouse/Rat Homology exists based"
print "         on the LL Official/Interim Symbol match."
print ""


select f.symbol "MGD Rat Symbol", f.name "MGD Rat Name", 
f.llsymbol "LL Symbol", f.symType "Type", f.llname "LL Name", f.gsdbID "LL RGD ID", f.locusID "LL ID",
