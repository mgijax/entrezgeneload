...
for line in infoFile.readlines():
	[taxID, geneID, symbol, locusTag, synonyms, dbxRefs, chr, mp, name] = string.splitfields(line[:-1], TAB)

	infoOutFile.write(taxID + TAB + geneID + TAB + symbol + TAB + locusTag + TAB + chr + TAB + mp + TAB + name[:255] + CRT)
